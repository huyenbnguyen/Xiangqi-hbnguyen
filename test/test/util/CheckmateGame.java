...
public class CheckmateGame {
	...
	public static XiangqiGame makeCheckmateGame() {
		initializer = new CheckmateInitializer();
...
class CheckmateInitializer extends InitializerTemplate {
	...
	protected void initializeBoard() {
		...
		board.placePiece(RED_CHARIOT, XNC.makeXNC(2, 5));
		board.placePiece(RED_CHARIOT, XNC.makeXNC(2, 6));
		board.placePiece(RED_GENERAL, XNC.makeXNC(1, 5));
		board.placePiece(RED_CHARIOT, XNC.makeXNC(2, 3));	
